...
module.exports.startRide = async (req, res) => {
    ...
    console.log(req.captain,'errride')
    try {
        const ride = await rideService.startRide({ rideId, otp, captain: captainId });
...
module.exports.endRide = async (req, res) => {
    ...
    const { rideId ,captainId} = req.body;
    try {
        const ride = await rideService.endRide({ rideId, captain: captainId });
